...
# Video sources
video_sources = {
    "1": "static/dataset/cctv1.mp4", #Add your path to first video
    "2": "static/dataset/cctv2.mp4", #Add your path to second video
    "3": "static/dataset/cctv3.mp4", #Add your path to third video
    "4": "static/dataset/cctv4.mp4"  #Add your path to fourth video
}
